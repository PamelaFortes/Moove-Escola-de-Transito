...
$string['enablecanvaslide'] = 'Enable Canva presentation slide';
$string['enablecanvaslidedesc'] = 'Enable display of Canva presentation slide on the frontpage';
$string['canvainlinehtml'] = 'Canva presentation HTML';
$string['canvainlinehtmldesc'] = 'Paste the Canva embed HTML code here (including iframe and div tags)';
...
// Footer settings tab.
$string['footerimage'] = 'Image for footer';
$string['footerimagedesc'] = 'set the image for the footer';
$string['footersettings'] = 'Footer';
$string['address'] = 'Address';
$string['addressdesc'] = 'Address description';
...
$string['followus'] = 'More';
$string['beteacher'] = 'Be our teacher';
$string['beteacherdesc'] = 'Be a teacher';
$string['ourteam'] = 'Our Team';
$string['ourteamdesc'] = 'Our team';
$string['ourhistory'] = 'Our history';
$string['ourhistorydesc'] = 'Our history';
$string['pdetran'] = 'Portal Detran';
$string['pdetrandesc'] = 'Portal Detran';
$string['copyright'] = 'Copyright';
$string['copyrightdesc'] = 'Copyright text';

//-----button portal settings-----
$string['portalbuttonsettings'] = 'Portal button settings';
$string['showportalbutton'] = 'Show portal button';
$string['showportalbutton_desc'] = 'If enabled, displays a button with a link to the Student Portal.';
$string['portalbuttonurl'] = 'Portal button URL';
$string['linkdesc'] = 'Enter the URL of your portal button.';
$string['link-button'] = 'Button link';
