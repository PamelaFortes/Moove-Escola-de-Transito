...
class settings {
    ...
    protected $files = [
        ...
        'sliderimage7', 'sliderimage8', 'sliderimage9', 'sliderimage10', 'sliderimage11', 'sliderimage12', 'sliderimage13', 'sliderimage14', 'sliderimage15',
    ...
    public function footer() {
        ...
        $settings = [
            'beteacher', 'ourteam', 'ourhistory', 'pdetran', 'copyright', 'address', 'facebook', 'twitter', 'linkedin', 'youtube', 'instagram', 'whatsapp', 'telegram',
            'website', 'mobile', 'mail',
        ];
    ...
    /**
     * Get config theme canva slide
     *
     * @return array
     */
    public function frontpage_canvaslide() {
        $templatecontext['enablecanvaslide'] = $this->enablecanvaslide;
        
        if ($templatecontext['enablecanvaslide']) {
            $templatecontext['canvainlinehtml'] = $this->canvainlinehtml;
        }
