...
class course_renderer extends \core_course_renderer
{
    ...
    public function render_loginform(\core\output\login\login_form $form)
    {
        $context = $form->export_for_template($this);

        // Adiciona os dados da configuração do botão
        $context['showportalbutton'] = get_config('theme_moove', 'showportalbutton');
        $context['link_url'] = ''; // ajustar link quando tiver dominio
        $context['link_text'] = '← Voltar ao';
