...
class core_renderer extends \theme_boost\output\core_renderer
{
    ...
    /**
     * Whether we should display the main theme or site Image in the footer.
     *
     * @return bool
     */
    public function should_display_footerimage()
    {
        if ($this->should_display_theme_footerimage()) {
            return true;
        }
    ...
    /**
     * Whether we should display the main theme Footer in the navbar.
     *
     * @return bool
     */
    public function should_display_theme_footerimage()
    {
        $footerimage = $this->get_theme_footerimage_url();

        return !empty($footerimage);
    }
    ...
    /**
     * Get the main Footer image URL.
     *
     * @return string
     */
    public function get_footerimage()
    {
        $footerimage = $this->get_theme_footerimage_url();
        ...
        $logo = $this->get_footerimage_url();

        if ($footerimage) {
            return $footerimage->out(false);
        }
     ...
     * @return string
     */
    public function get_theme_footerimage_url()
    {
        $theme = theme_config::load('moove');

        return $theme->setting_file_url('footerimage', 'footerimage');
    }
    ...
    public function render_login(\core_auth\output\login $form)
    {
        ...
        // If the portal button is enabled, we add the link to the login form.
        $showportalbutton = get_config('theme_moove', 'showportalbutton');
        $portalurl = get_config('theme_moove', 'portalbuttonurl');

        // Add to context if the button is enabled

        if ($showportalbutton && !empty($portalurl)) {
            $context->portalbutton = html_writer::link(
                $portalurl,
                'Portal do Aluno',
