...
if ($ADMIN->fulltree) {
    ...
    // Canva slide settings.
    $name = 'theme_moove/enablecanvaslide';
    $title = get_string('enablecanvaslide', 'theme_moove');
    $description = get_string('enablecanvaslidedesc', 'theme_moove');
    $default = 0;
    $choices = [0 => get_string('no'), 1 => get_string('yes')];
    $setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
    $page->add($setting);

    $name = 'theme_moove/canvainlinehtml';
    $title = get_string('canvainlinehtml', 'theme_moove');
    $description = get_string('canvainlinehtmldesc', 'theme_moove');
    ...
    // Footer image.
    $fileid = 'footerimage' . $footerimageindex;
    $name = 'theme_moove/footerimage' . $footerimageindex;
    $title = get_string('footerimage', 'theme_moove');
    $description = get_string('footerimagedesc', 'theme_moove');
    $opts = ['accepted_types' => ['.png', '.jpg', '.gif', '.webp', '.tiff', '.svg'], 'maxfiles' => 1];
    $setting = new admin_setting_configstoredfile($name, $title, $description, $fileid, 0, $opts);
    $page->add($setting);
    ...
    // Teacher url setting.
    $name = 'theme_moove/beteacher';
    $title = get_string('beteacher', 'theme_moove');
    $description = get_string('beteacherdesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);

    // Team url setting.
    $name = 'theme_moove/ourteam';
    $title = get_string('ourteam', 'theme_moove');
    $description = get_string('ourteamdesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);

    // History url setting.
    $name = 'theme_moove/ourhistory';
    $title = get_string('ourhistory', 'theme_moove');
    $description = get_string('ourhistorydesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);

    // PortalDetran url setting.
    $name = 'theme_moove/pdetran';
    $title = get_string('pdetran', 'theme_moove');
    $description = get_string('pdetrandesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);
    ...
    // Copyright.
    $name = 'theme_moove/copyright';
    $title = get_string('copyright', 'theme_moove');
    $description = get_string('copyrightdesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);

    $settings->add($page);

    //--------------------SHOW BUTTON BACK TO PORTAL settings tab--------------------*/

    $page = new admin_settingpage('theme_moove_PortalButton', get_string('portalbuttonsettings', 'theme_moove'));
    $name = 'theme_moove/showportalbutton';
    $title = get_string('showportalbutton', 'theme_moove');
    $description = get_string('showportalbutton_desc', 'theme_moove');
    $default = 1;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    $page->add($setting);

    //add url btn
    $name = 'theme_moove/portalbuttonurl';
    $title = get_string('link-button', 'theme_moove');
    $description = get_string('linkdesc', 'theme_moove');
    $setting = new admin_setting_configtext($name, $title, $description, '');
    $page->add($setting);
